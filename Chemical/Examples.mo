...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature
    ...
    Chemical.Components.GasSolubility gasSolubility1(K=1e50)
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model CarbonDioxideInBlood
      ...
      Chemical.Components.Membrane aquaporin
       annotation (Placement(
            ...
            origin={-34,-16})));
      //(KC=KC)
      Chemical.Components.Membrane Band3_HCO3
       annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={4,-16})));
      //(KC=KC)
      Chemical.Components.Membrane Band3_Cl(useKineticsInput=false)
        annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={46,-16})));
    ...
    package Dev
      model RedCellMembrane
       // import Chemical;
        ...
        Chemical.Components.Membrane Aquapirin
         annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-168,0})));             //(KC=KC)
        Chemical.Components.Membrane Band3
         annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-6,0})));           //(KC=KC)
        Chemical.Components.Membrane Band3_(useKineticsInput=false)
          annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={18,0})));                                   //, KC=KC
        ...
        Chemical.Components.Membrane leak(useKineticsInput=false)
          annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={140,0})));
        ...
        Chemical.Components.Membrane MCT_(useKineticsInput=false)
        ...
        Chemical.Components.Membrane MCT(useKineticsInput=false)
          "Monocarboxylate transporters" annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={52,0})));                                //, KC=KC
        ...
        Chemical.Components.Membrane freeCO2
         annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
        ...
        Chemical.Components.Membrane freeO2
         annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
  ...
  package Hemoglobin "Hemoglobin blood gases binding"
    model Allosteric_Hemoglobin_MWC "Monod,Wyman,Changeux (1965)"
      ...
      Chemical.Components.Reaction quaternaryForm(
        nS=1,
        nP=1,
        K=KC) annotation (Placement(transformation(extent={{4,78},{24,98}})));
      Chemical.Components.Reaction oxyR1(
        nS=1,
        nP=2,
        K=KC) annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={-8,64})));
      ...
      Chemical.Components.Reaction quaternaryForm1(
        nS=1,
        nP=1,
        K=KC) annotation (Placement(transformation(extent={{8,36},{28,56}})));
      ...
      Chemical.Components.GasSolubility gasSolubility(K=KC)
    ...
    model Allosteric_Hemoglobin2_MWC
      ...
      Chemical.Sources.ExternalIdealGasSubstance oxygen_in_air(
          usePartialPressureInput=true, substanceData=
            ...
            rotation=270,
            origin={8,68})));
      Chemical.Components.GasSolubility partialPressure1(K=KC) annotation (
    ...
    //   (AmountOfSolutionIn1L -  THb - (initialO2 + initialCO2)*AmountOfSolutionIn1L)/55.508)
      ...
      Chemical.Sources.ExternalIdealGasSubstance CO2_gas(
        ...
        Temperature=310.15) annotation (Placement(transformation(
            ...
            rotation=270,
            origin={62,60})));
      Chemical.Components.GasSolubility partialPressure2(K=KC) annotation (
...
<p>M. Matej&aacute;k, T. Kulh&aacute;nek, and S. Matou&scaron;ek, &quot;Adair-based hemoglobin equilibrium with oxygen, carbon dioxide and hydrogen ion activity,&quot; Scandinavian Journal of Clinical &amp; Laboratory Investigation, pp. 1-8, 2015.</p>
    ...
    model HemoglobinMultipleAllosteryCO
      ...
      Chemical.Components.GasSolubility partialPressure3(K=KC) annotation (
    ...
    model StandardElectrochemicalCell2
     ...
     extends Modelica.Icons.Example;
      ...
      Chemical.Components.Reaction electrodeReaction1(
        ...
        p={2,8,8},                                    nS=1,
        nP=3,
        substrates(redeclare package stateOfMatter = Interfaces.Incompressible))
                                                                  annotation (
         Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
