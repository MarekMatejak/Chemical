...
package Obsolete
  package Components "Chemical Components"
    ...
    model Substance "Substance in solution"
      ...
      extends
        .Chemical.Obsolete.Interfaces.PartialSubstanceInSolutionWithAdditionalPorts;
...
<p><br>Be carefull, DfS is not the same as absolute entropy of the substance S&deg; from III. thermodinamic law! It must be calculated from tabulated value of DfG(298.15 K) and DfH as DfS=(DfH - DfG)/298.15. </p>
    ...
    model Reaction "Chemical Reaction"
      extends Chemical.Obsolete.Interfaces.ConditionalKinetics;
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
  ...
  package Sensors "Chemical sensors"
    ...
    model MolarFlowSensor "Measure of molar flow"
      ...
      Chemical.Interfaces.InletProvider inlet annotation (Placement(transformation(extent={{-108,-10},{-88,10}})));
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
  ...
  extends Modelica.Icons.ExamplesPackage;
    ...
    model SimpleReaction
      ...
      Chemical.Obsolete.Components.Reaction reaction(nS=1, nP=1)
...
<p>Simple reaction demonstrating equilibria between substance A and substance B, mixed in one solution. Observe the molar concentration (A.c) and molar fraction. Note, that mole fraction (A.x and B.x) are always summed to 1 for the solution.</p>
    ...
    model SimpleReaction2
      ...
      Chemical.Obsolete.Components.Substance A(use_mass_start=false,
          amountOfSubstance_start=0.1)
        annotation (Placement(transformation(extent={{-34,2},{-14,22}})));
      Chemical.Obsolete.Components.Reaction reaction(nS=2, nP=1)
        annotation (Placement(transformation(extent={{4,-8},{24,12}})));
      Chemical.Obsolete.Components.Substance B(use_mass_start=false,
          amountOfSubstance_start=0.1)
...
<p>Simple reaction demonstrating equilibria between substance A, B, and substance C, mixed in one solution. Observe the molar concentration (A.c) and molar fraction. Note, that molar fractions (A.x and B.x and C.x) are always summed to 1 for the whole solution.</p>
    ...
    model HeatingOfWater "Heating of 1 kg water"
      ...
      Chemical.Solution solution(useMechanicPorts=true, useThermalPort=true)
        annotation (Placement(transformation(extent={{-100,-100},{100,100}})));
      ...
      Chemical.Obsolete.Components.Substance liquidWater(mass_start=1,
...
<p>Observe Solution.T (or H2O.Solution.T) for temperature change.</p>
    ...
    model HeatingOfAlcohol "Heating of 50% ethanol"
      ...
      Modelica.Mechanics.Translational.Components.Fixed fixed1
        annotation (Placement(transformation(extent={{-28,-94},{-8,-74}})));
      Chemical.Obsolete.Components.Substance liquidWater(mass_start=1/2,
          substanceData=Chemical.Substances.Water_liquid())
...
<p>Observe Solution.T (or H2O.Solution.T or Ethanol.Solution.T) for temperature change. Note, that we can heat all substances in solution at once and the results would differ from HeatingOfWater.</p>
    ...
    model ExothermicReaction
      ...
      Chemical.Solution thermal_isolated_solution(useMechanicPorts=true,
      ...
      Chemical.Solution solution_at_constant_temperature(useMechanicPorts=true,
          useThermalPort=true)
        annotation (Placement(transformation(extent={{-100,0},{98,94}})));
      Chemical.Obsolete.Components.Substance A1(use_mass_start=false,
          amountOfSubstance_start=0.9)
        annotation (Placement(transformation(extent={{-40,40},{-20,60}})));
      Chemical.Obsolete.Components.Reaction reaction1(nS=1, nP=1)
      ...
      Chemical.Obsolete.Components.Substance H2O(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=1)
        annotation (Placement(transformation(extent={{20,4},{40,24}})));
      Chemical.Obsolete.Components.Substance H2O1(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=1)
...
<p>Demonstration of exotermic reaction with perfect cooling (i.e. connected fixed temperature to the HeatPort) and thermally insulated (HetPort unconnected). See solution_(...).T</p>
    ...
    model HydrogenCombustion "Hydrogen combustion in piston"
     ...
     // parameter Modelica.SIunits.Pressure p=100000 "Initial pressure";
      ...
      Chemical.Solution idealGas1(
        SurfaceArea=A,
        useMechanicPorts=true,
        useThermalPort=true,
        redeclare package stateOfMatter = Chemical.Interfaces.IdealGas)
        annotation (Placement(transformation(extent={{18,-52},{118,48}})));
      Chemical.Obsolete.Components.Substance H2_gas1(
      ...
      Chemical.Obsolete.Components.Substance O2_gas1(
      ...
      Chemical.Obsolete.Components.Substance H2O_gas1(
      ...
      Chemical.Obsolete.Components.Reaction reaction1(
        nS=2,
        s={2,1},
        p={2},
        kE=4e-05,
...
<p><br>However, in the real world, there is always some thermal energy flow from the solution, and this cooling process can be connected using the thermal connector of the Modelica Standard Library 3.2.1. For example, the simple thermal conductor of thermal conductance 2W/K at a constant temperature environment of 25&deg;C is represented in the model. The mechanical power of the engine can be connected to the robust mechanical model. However, in our example we selected only a very strong mechanical spring with a spring constant of 10<sup>6</sup> N/m to stop the motion of the piston in order to generate the pressure. This standard spring component is situated above the solution in the model diagram. The results of this experiment are shown in Figure 1. </p>
    ...
    model WaterVaporization "Evaporation of water"
      ...
      Chemical.Solution liquid(temperature_start=T_start, useThermalPort=true)
    ...
    Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor(
      ...
      Chemical.Obsolete.Components.Substance liquidWater(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=1)
      ...
      Chemical.Obsolete.Components.GasSolubility gasSolubility
        annotation (Placement(transformation(extent={{-92,16},{-72,36}})));
      Chemical.Obsolete.Sensors.PartialPressureSensor pH2O(redeclare package
          stateOfMatter = Chemical.Interfaces.IdealGas, substanceData=
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature
      ...
      Chemical.Obsolete.Components.GasSolubility gasSolubility1(KC=10)
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model GasSolubility_NIST "Dissolution of gases in liquids"
      ...
      Chemical.Solution water_solution_25degC(temperature_start=298.15)
        annotation (Placement(transformation(extent={{-160,-78},{-68,12}})));
                                          //(amountOfSolution_start=52.3)
      Chemical.Solution water_solution_37degC(temperature_start=310.15)
        annotation (Placement(transformation(extent={{-52,-80},{42,12}})));
                                       //(amountOfSolution_start=39.7)
      Chemical.Obsolete.Components.GasSolubility CO2_dissolutionP
      ...
      Chemical.Obsolete.Components.GasSolubility O2_dissolutionP
      ...
      Chemical.Obsolete.Components.GasSolubility CO2_dissolutionE
      ...
      Chemical.Obsolete.Components.GasSolubility O2_dissolutionE_NIST
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model GasSolubility "Dissolution of gases in liquids"
      ...
      Chemical.Solution blood_plasma
        annotation (Placement(transformation(extent={{-100,-76},{-8,14}})));
                                          //(amountOfSolution_start=52.3)
      Chemical.Solution red_cells
      ...
      Chemical.Obsolete.Components.Substance water_plasma(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=0.82)
        annotation (Placement(transformation(extent={{-40,-66},{-20,-46}})));
      Chemical.Obsolete.Components.Substance water(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=1)
      ...
      Chemical.Obsolete.Components.Substance water_plasma1(mass_start=0.18,
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model GasSolubility_blood "Dissolution of gases in liquids"
      ...
      inner Modelica.Fluid.System system(p_ambient(displayUnit="mmHg")=
          101325.0144354, T_ambient=310.15)
        annotation (Placement(transformation(extent={{-10,-96},{10,-76}})));
      Chemical.Obsolete.Components.Substance others(mass_start=0.18,
          substanceData=Chemical.Interfaces.Incompressible.SubstanceData(
                MolarWeight=1/0.627))
        annotation (Placement(transformation(extent={{-76,-66},{-56,-46}})));
    equation
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model EnzymeKinetics "Basic enzyme kinetics"
      ...
      Chemical.Obsolete.Components.Substance S(use_mass_start=false,
          amountOfSubstance_start=1)
      ...
      Chemical.Obsolete.Components.Substance E(use_mass_start=false,
          amountOfSubstance_start=tE/2)
...
<p>If the equilibrium of the reaction is reached only by forward rate then xP*xE/xES must be less than the dissociation constant.</p>
    ...
    model ElectrochemicalCell
     ...
     extends Modelica.Icons.Example;
      ...
      Chemical.Solution cathode(ElectricGround=false)
      ...
      Chemical.Solution anode(ElectricGround=false)
        annotation (Placement(transformation(extent={{62,-50},{96,50}})));

      Chemical.Solution solution1(ElectricGround=false)
    ...
    model LeadAcidBattery
     ...
     extends Modelica.Icons.Example;
      ...
      Chemical.Obsolete.Components.Substance PbO2(
        ...
        use_mass_start=false,
        amountOfSubstance_start=50) annotation (Placement(transformation(extent
              ={{-10,-10},{10,10}}, origin={-60,-58})));
      Chemical.Obsolete.Components.Substance H2O(mass_start(displayUnit="g") =
          0.114, substanceData=Chemical.Substances.Water_liquid())
        annotation (Placement(transformation(extent={{-2,-8},{-22,12}})));
      Chemical.Obsolete.Components.Substance PbSO4(
        amountOfSubstance_start=0.001,
        substanceData=Chemical.Substances.LeadSulfate_solid(),
        use_mass_start=false) annotation (Placement(transformation(extent={{-10,
                -10},{10,10}}, origin={-60,6})));
...
<p>Figure 2) Discharging simulation of the lead-acid battery cell from Figure 2D, with the initial amount of substances as described in the text.</p>
    ...
    package AcidBase
      ...
      model WaterSelfIonization "H2O  <->  OH-   +   H+ "
        ...
        Chemical.Obsolete.Components.Substance H2O(mass_start=1, substanceData=
        ...
        Chemical.Obsolete.Components.Substance H2O_(mass_start=1, substanceData
            =Chemical.Substances.Water_liquid()) annotation (Placement(
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model CarbonDioxideInWater "CO2 as alone acid-base buffer"
        ...
        Chemical.Obsolete.Components.GasSolubility gasSolubility(KC=KC)
        ...
        Chemical.Obsolete.Components.Reaction waterDissociation(
          ...
          nP=2,
          nS=1,
          useKineticsInput=false) "water dissociation"
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model Phosphate
        ...
        Chemical.Obsolete.Components.Substance H(
          substanceData=Chemical.Substances.Proton_aqueous(),
          use_mass_start=false,
          amountOfSubstance_start=10^(-7.4)) "hydrogen ions activity"
          annotation (Placement(transformation(extent={{-10,-10},{10,10}},
                origin={28,-14})));
        ...
        Chemical.Obsolete.Components.Substance OH(
          substanceData=Chemical.Substances.Hydroxide_aqueous(),
          use_mass_start=false,
          amountOfSubstance_start=10^(-14 + 7.4)) annotation (Placement(
              transformation(extent={{-10,-10},{10,10}}, origin={28,32})));
        Chemical.Obsolete.Components.Reaction reaction(
          KC=KC,
          nS=2,
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model CarbonDioxideInBlood
        ...
        Chemical.Solution blood_erythrocytes(ElectricGround=false,
            temperature_start=310.15)
          annotation (Placement(transformation(extent={{-100,-98},{100,-38}})));
        Chemical.Solution blood_plasma(temperature_start=310.15)
        ...
        Chemical.Obsolete.Components.Substance H2O_E(substanceData=
        ...
        Chemical.Obsolete.Components.Membrane aquaporin(KC=KC) annotation (
            Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-34,-16})));
        Chemical.Obsolete.Components.Membrane Band3_HCO3(KC=KC) annotation (
            Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={4,-16})));
        Chemical.Obsolete.Components.Membrane Band3_Cl(useKineticsInput=false,
        ...
        Chemical.Obsolete.Components.Substance others_E(
          substanceData=Chemical.Interfaces.Incompressible.SubstanceData(
                    ...
                    References={
                "erythrocyte intracellular fluid density 1045kg/m3"},
                    MolarWeight=(1.045 - 0.695523)/(38.7*(1 - 0.994648) -
                0.0499 - 0.0116 - 0.00123)),
          use_mass_start=false,
        ...
        Chemical.Obsolete.Components.Substance others_P(
          substanceData=Chemical.Interfaces.Incompressible.SubstanceData(
                ...
                "to reach plasma density 1024 kg/m3 and plasma volume 1 liter"},
                    ...
                    MolarWeight=(1.024 - 0.933373)/(51.8*(1 - 0.994648) - 0.103
                 - 0.024 - 0.0017)),
          use_mass_start=false,
          amountOfSubstance_start=0.1487)
          annotation (Placement(transformation(extent={{70,14},{90,34}})));
        Chemical.Obsolete.Components.Diffusion diffusion annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-66,-16})));
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model AcidBaseBufferTest
        ...
        Chemical.Solution simpleSolution
          annotation (Placement(transformation(extent={{-104,-100},{96,100}})));
        Chemical.Obsolete.Sources.ExternalMoleFraction externalMoleFraction(
            substanceData=Chemical.Substances.Proton_aqueous(), MoleFraction=10
              ^(-7.1))
      ...
      package Dev
        model RedCellMembrane
         // import Chemical;
          ...
          Chemical.Solution blood_plasma annotation (Placement(transformation(
                  extent={{-180,12},{180,100}})));

          Chemical.Obsolete.Components.Substance HCO3(
            substanceData=Chemical.Substances.Bicarbonate_blood(),
            use_mass_start=false,
            amountOfSubstance_start=0.024) annotation (Placement(transformation(
                  extent={{-10,-10},{10,10}}, origin={-18,30})));

          Chemical.Obsolete.Components.Substance H2O(substanceData=
                Chemical.Substances.Water_liquid(), mass_start=51.8*0.994648/
                55.508) annotation (Placement(transformation(extent={{-146,44},
                    {-166,64}})));
          Chemical.Obsolete.Components.Substance HCO3_E(
            substanceData=Chemical.Substances.Bicarbonate_blood(),
            use_mass_start=false,
          ...
          Chemical.Obsolete.Components.Membrane Aquapirin(KC=KC) annotation (
              Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={-168,0})));
          Chemical.Obsolete.Components.Membrane Band3(KC=KC) annotation (
              Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={-6,0})));
          Chemical.Obsolete.Components.Membrane Band3_(useKineticsInput=false,
              KC=KC) annotation (Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={18,0})));
          Chemical.Obsolete.Components.Substance permeableUncharged(
              use_mass_start=false, amountOfSubstance_start=0.0118)
          ...
          Chemical.Obsolete.Components.Substance permeableUncharged_E(
            ...
            use_mass_start=false,
            amountOfSubstance_start=0.00903) annotation (Placement(
                transformation(extent={{164,-38},{144,-18}})));
          Chemical.Obsolete.Components.Substance chargedImpermeable_E(
            substanceData(MolarWeight=1),
            use_mass_start=false,
            amountOfSubstance_start=0.0165) annotation (Placement(
                transformation(extent={{144,-62},{164,-42}})));
          Chemical.Obsolete.Components.Membrane leak(useKineticsInput=false, KC
          ...
          Chemical.Obsolete.Components.Membrane MCT_(useKineticsInput=false, KC
          ...
          Chemical.Obsolete.Components.Membrane MCT(useKineticsInput=false, KC=
                KC) "Monocarboxylate transporters" annotation (Placement(
                transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
          ...
          Chemical.Obsolete.Components.Membrane freeCO2(KC=KC) annotation (
              Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={-38,2})));
          ...
          Chemical.Obsolete.Components.Membrane freeO2(KC=KC) annotation (
              Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={118,0})));
          ...
          Chemical.Obsolete.Components.Substance K(
            ...
            use_mass_start=false,
            amountOfSubstance_start=0.004) annotation (Placement(transformation(
                  extent={{-100,20},{-120,40}})));
          Chemical.Obsolete.Components.Substance Na(
            substanceData=Chemical.Substances.Sodium_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.138) annotation (Placement(transformation(
                  extent={{-124,20},{-144,40}})));
          Chemical.Obsolete.Components.Substance Na_E(
            substanceData=Chemical.Substances.Sodium_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.007) annotation (Placement(transformation(
                  extent={{-118,-38},{-138,-18}})));
          Chemical.Obsolete.Components.Substance K_E(
            substanceData=Chemical.Substances.Potassium_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.096) annotation (Placement(transformation(
                  extent={{-112,-38},{-92,-18}})));
          Chemical.Obsolete.Components.Substance H2PO4_E(
            substanceData=Chemical.Substances.DihydrogenPhosphate_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.000175) annotation (Placement(
                transformation(extent={{-84,-38},{-64,-18}})));
          Chemical.Obsolete.Components.Substance ADP_E(
            substanceData(z=-3),
            use_mass_start=false,
            amountOfSubstance_start=9.6e-05) annotation (Placement(
                transformation(extent={{-114,-62},{-94,-42}})));
          Chemical.Obsolete.Components.Substance ATP_E(
            ...
            use_mass_start=false,
            amountOfSubstance_start=0.00128) annotation (Placement(
                transformation(extent={{-146,-62},{-166,-42}})));

          Chemical.Obsolete.Components.Substance HPO4_E(
            substanceData=Chemical.Substances.HydrogenPhosphate_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.000495) annotation (Placement(
                transformation(extent={{-84,-62},{-64,-42}})));
          ...
          Chemical.Obsolete.Components.Substance Mg(
            ...
            use_mass_start=false,
            amountOfSubstance_start=0.00108) "Mg2+" annotation (Placement(
                transformation(extent={{-112,-84},{-92,-64}})));
          Chemical.Obsolete.Components.Substance DPG(
            substanceData(
              ...
              density=1000),
            use_mass_start=false,
            amountOfSubstance_start=0.0051) annotation (Placement(
                transformation(extent={{128,-94},{108,-74}})));
          Chemical.Obsolete.Components.Substance GSH(
            substanceData(
              ...
              density=1000),
            use_mass_start=false,
            amountOfSubstance_start=0.00223) annotation (Placement(
                transformation(extent={{164,-94},{144,-74}})));
          Chemical.Obsolete.Components.Reaction HendersonHasselbalch(
            nP=2,
            nS=2,
            useKineticsInput=false) "K=10^(-6.103 + 3), dH=7.3 kJ/mol"
            annotation (Placement(transformation(extent={{-34,64},{-14,44}})));
          Chemical.Obsolete.Sources.Buffer Hemoglobin(
            substanceData(z=1.045),
            a_start=10^(-7.2),
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
        ...
        model NaKATPase
          Chemical.Solution ICF(ElectricGround=false) annotation (Placement(
                transformation(extent={{-100,-100},{-20,98}})));
          Chemical.Solution ECF annotation (Placement(transformation(extent={{
                    28,-100},{100,100}})));
          Chemical.Obsolete.Components.Substance water_ICF(substanceData=
                Chemical.Substances.Water_liquid(), mass_start=1)
            annotation (Placement(transformation(extent={{-82,70},{-62,90}})));
          Chemical.Obsolete.Components.Substance water_EFC(substanceData=
                Chemical.Substances.Water_liquid(), mass_start=1)
            annotation (Placement(transformation(extent={{58,56},{38,76}})));
          Chemical.Obsolete.Components.Reaction NaKATPase(
            nS=4,
            nP=4,
            s={3,2,1,1},
          ...
          Chemical.Obsolete.Components.Substance Na_ECF(
            amountOfSubstance_start(displayUnit="mmol") = 0.14,
            substanceData=Chemical.Substances.Sodium_aqueous(),
            use_mass_start=false)
            annotation (Placement(transformation(extent={{58,-26},{38,-6}})));
          Chemical.Obsolete.Components.Substance K_ECF(
            amountOfSubstance_start(displayUnit="mmol") = 0.005,
            substanceData=Chemical.Substances.Potassium_aqueous(),
            use_mass_start=false)
            annotation (Placement(transformation(extent={{58,28},{38,48}})));
          Chemical.Obsolete.Components.Substance ADP3(
            substanceData=Chemical.Substances.ADP3_aqueous(),
            use_mass_start=false,
            amountOfSubstance_start=0.005/150) annotation (Placement(
                transformation(extent={{-82,-42},{-62,-22}})));
          Chemical.Obsolete.Components.Substance H2PO4_ICF(
            amountOfSubstance_start(displayUnit="mmol") = 0.036,
            substanceData=Chemical.Substances.DihydrogenPhosphate_aqueous(),
            use_mass_start=false) annotation (Placement(transformation(extent={
                    {-82,-68},{-62,-48}})));
          inner Modelica.Fluid.System system(T_ambient=310.15)
            annotation (Placement(transformation(extent={{-6,-90},{14,-70}})));
          Chemical.Obsolete.Components.Substance Cl_ICF(
            amountOfSubstance_start(displayUnit="mmol") = 0.0987,
            substanceData=Chemical.Substances.Chloride_aqueous(),
            use_mass_start=false) annotation (Placement(transformation(extent={
                    {-82,-92},{-62,-72}})));
          Chemical.Obsolete.Components.Substance Cl_ECF(
      ...
      model AlbuminTitration "Figge-Fencl model (22. Dec. 2007)"
        ...
        Chemical.Obsolete.Components.Substance H2O(substanceData=
              Chemical.Substances.Water_liquid(), mass_start=1) annotation (
            Placement(transformation(extent={{-10,-10},{10,10}}, origin={62,-68})));
        Chemical.Obsolete.Sources.ExternalMoleFraction H(substanceData=
...
<p><font style=\"color: #222222; \">Jame Figge: Role of non-volatile weak acids (albumin, phosphate and citrate). In: Stewart&apos;s Textbook of Acid-Base, 2nd Edition, John A. Kellum, Paul WG Elbers editors, &nbsp;AcidBase org, 2009, pp. 216-232.</font></p>
    ...
    package Hemoglobin "Hemoglobin blood gases binding"
      model Allosteric_Hemoglobin_MWC "Monod,Wyman,Changeux (1965)"
        ...
        Real sO2;
        Chemical.Obsolete.Components.Substance substance(substanceData=
              Chemical.Substances.Water_liquid(), mass_start=1)
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model Allosteric_Hemoglobin2_MWC
        ...
        Chemical.Obsolete.Components.Speciation R0_in_R(NumberOfSubunits=4)
          annotation (Placement(transformation(extent={{-46,-48},{-26,-28}})));
         // AmountOfSubstance_start=4e-11)
        Chemical.Obsolete.Components.Speciation T0_in_T(NumberOfSubunits=4)
        ...
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance oxygen_in_air(
            usePartialPressureInput=true, substanceData=
              ...
              rotation=270,
              origin={8,68})));
        Chemical.Obsolete.Components.GasSolubility partialPressure1(KC=KC)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}},
                origin={8,40})));
...
<p><br>Parameters was fitted to data of Severinghaus article from 1979. (For example at pO2=26mmHg is oxygen saturation sO2 = 48.27 %).</p>
      ...
      model HemoglobinQuaternaryForm
        ...
        Chemical.Obsolete.Components.Speciation speciation(NumberOfSubunits=N)
        ...
        Chemical.Interfaces.SolutionPort solution annotation (Placement(
              transformation(extent={{-50,-82},{-32,-62}}), iconTransformation(
                extent={{-50,-90},{-30,-70}})));
        Chemical.Obsolete.Interfaces.SubstancePort_b O2 annotation (Placement(
              transformation(extent={{-28,32},{-8,52}}), iconTransformation(
                extent={{-90,70},{-70,90}})));
        Chemical.Obsolete.Interfaces.SubstancePort_a selectedForm annotation (
        ...
        Chemical.Obsolete.Interfaces.SubstancePort_b CO2 annotation (Placement(
              transformation(extent={{-8,-26},{12,-6}}), iconTransformation(
                extent={{10,70},{30,90}})));
        Chemical.Obsolete.Components.Substance HmNHCOO[4](
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,

          each substanceData(DfG=DfG_CO2 - RT*log(Kc25) + DfG_selectedForm/N,
        ...
        Chemical.Obsolete.Interfaces.SubstancePort_b H annotation (Placement(
...
<p>M. Matej&aacute;k, T. Kulh&aacute;nek, and S. Matou&scaron;ek, &quot;Adair-based hemoglobin equilibrium with oxygen, carbon dioxide and hydrogen ion activity,&quot; Scandinavian Journal of Clinical &amp; Laboratory Investigation, pp. 1-8, 2015.</p>
      ...
      model HemoglobinMultipleAllostery
        ...
        Chemical.Solution solution(temperature_start=310.15)
      ...
      //   (AmountOfSolutionIn1L -  THb - (initialO2 + initialCO2)*AmountOfSolutionIn1L)/55.508)
        ...
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance CO2_gas(
          ...
          Temperature=310.15) annotation (Placement(transformation(
              ...
              rotation=270,
              origin={62,60})));
        Chemical.Obsolete.Components.GasSolubility partialPressure2(KC=KC)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}},
                origin={62,32})));
      ...
      model HemoglobinQuaternaryFormCO
        ...
        Chemical.Obsolete.Components.Substance COHm[4](
          ...
          each amountOfSubstance_start=(initialCO/Kco37)*initialHb/(1 +
              initialO2/Ko37 + initialCO/Kco37)) "Subunit with Carbon Monoxide"
          annotation (Placement(transformation(extent={{78,44},{58,64}})));
        ...
        Chemical.Obsolete.Interfaces.SubstancePort_b CO annotation (Placement(
...
<p>M. Matej&aacute;k, T. Kulh&aacute;nek, and S. Matou&scaron;ek, &quot;Adair-based hemoglobin equilibrium with oxygen, carbon dioxide and hydrogen ion activity,&quot; Scandinavian Journal of Clinical &amp; Laboratory Investigation, pp. 1-8, 2015.</p>
      ...
      model HemoglobinMultipleAllosteryCO
        ...
        Chemical.Obsolete.Components.GasSolubility partialPressure3(KC=KC)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}},
                origin={26,32})));
...
<p><br>T .. temperature</p>
    ...
    package CheckSubstancesData
      model SimpleReaction
        ...
        Chemical.Obsolete.Sensors.DissociationCoefficient
          dissociationCoefficient(nS=1, nP=1)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
        Chemical.Obsolete.Sources.PureSubstance A(redeclare package
            stateOfMatter = Chemical.Interfaces.Incompressible, substanceData(
              DfG=0))
          annotation (Placement(transformation(extent={{-56,-10},{-36,10}})));
        Chemical.Obsolete.Sources.PureSubstance B(redeclare package
            stateOfMatter = Chemical.Interfaces.Incompressible, substanceData(
              DfG=-R*T_25degC*log(K)))
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model SimpleReaction2
        ...
        Chemical.Obsolete.Sources.PureSubstance A
          annotation (Placement(transformation(extent={{-34,2},{-14,22}})));
        Chemical.Obsolete.Sensors.DissociationCoefficient reaction(nS=2, nP=1)
          annotation (Placement(transformation(extent={{4,-8},{24,12}})));
        Chemical.Obsolete.Sources.PureSubstance B
          annotation (Placement(transformation(extent={{-34,-24},{-14,-4}})));
        Chemical.Obsolete.Sources.PureSubstance C(substanceData(DfG=-R*T_25degC
                *log(Kx)))
          annotation (Placement(transformation(extent={{68,-8},{48,12}})));
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model SimpleReaction2_Get_DfG
        ...
        Chemical.Obsolete.Sensors.DissociationCoefficient reaction(nP=1, nS=2)
        ...
        Chemical.Obsolete.Sources.ExternalElectroChemicalPotential C(
      ...
      model StandardElectrochemicalCell
       ...
       extends Modelica.Icons.Example;
        ...
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance H2(
          ...
          TotalPressure=100000)
          annotation (Placement(transformation(extent={{24,32},{44,52}})));
        Chemical.Obsolete.Sources.PureSubstance H(substanceData=
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model StandardLeadAcidPotential
       ...
       extends Modelica.Icons.Example;
        ...
        Chemical.Obsolete.Sources.PureSubstance PbO2(substanceData=
              Chemical.Substances.LeadDioxide_solid()) annotation (Placement(
              transformation(extent={{-10,-10},{10,10}}, origin={-74,-30})));
        Chemical.Obsolete.Sources.PureSubstance H2O(substanceData=
              Chemical.Substances.Water_liquid())
          annotation (Placement(transformation(extent={{-2,-10},{-22,10}})));
        Chemical.Obsolete.Sources.PureSubstance PbSO4(substanceData=
      ...
      model StandardElectrochemicalCell2
       ...
       extends Modelica.Icons.Example;
        ...
        Chemical.Obsolete.Sources.PureSubstance H2O(substanceData=
              Chemical.Substances.Water_liquid())
          annotation (Placement(transformation(extent={{-8,-36},{-28,-16}})));
        Chemical.Obsolete.Sources.PureSubstance O2(redeclare package
            stateOfMatter = Chemical.Interfaces.IdealGas, substanceData=
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
    ...
    model WaterElectrolysis "Water electrolysis"
      ...
      Chemical.Solution water(temperature_start=310.15)
...
<p><b>2 H<sub>2</sub>O +&nbsp;&nbsp;4 e<sup>-</sup><sub>(catode)</sub>&nbsp;&lt;-&gt;  2 H<sub>2</sub> + O<sub>2</sub>&nbsp;+&nbsp;&nbsp;4 e<sup>-</sup><sub>(anode)</sub>&nbsp;</b></p>
    ...
    Modelica.Electrical.Analog.Basic.Ground ground
      ...
      Chemical.Obsolete.Components.Substance H2O(substanceData=
            Chemical.Substances.Water_liquid(), mass_start=1)
        annotation (Placement(transformation(extent={{-6,-54},{14,-34}})));
      Chemical.Obsolete.Sources.ExternalIdealGasSubstance O2_(
        substanceData=Chemical.Substances.Oxygen_gas(),
        PartialPressure=100000,
        TotalPressure=100000)
...
<td>Anirudh Bhanu Teja Nelabhotla, Rune Bakke, Carlos Dinamarca,
	...
	<a href=\"https://doi.org/10.3390/catal9080683\">doi:10.3390/catal9080683</a>.
      ...
      model AcetoclasticMethanogenesis
        extends Modelica.Icons.Example;
        Chemical.Solution solution annotation (Placement(transformation(extent=
                  {{-100,-100},{100,100}})));
        Chemical.Obsolete.Components.Substance CH3COOH(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,
        ...
        Chemical.Obsolete.Components.Substance CH4(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,
        ...
        Chemical.Obsolete.Components.Substance Water(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,

          substanceData=Chemical.Substances.Water_liquid(),
          mass_start=1)
          annotation (Placement(transformation(extent={{-14,-66},{6,-46}})));
        Chemical.Obsolete.Components.Reaction reaction(nS=1, nP=2)
      ...
      model HydrogenotrophicMethanogenesis
        ...
        Chemical.Obsolete.Components.Substance H2O(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,
        ...
        Chemical.Obsolete.Components.Substance H2(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,
      ...
      Modelica.Electrical.Analog.Basic.Ground ground
        ...
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance O2_(
          ...
          TotalPressure=100000)
          annotation (Placement(transformation(extent={{-6,32},{-26,52}})));
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance CO2(
          substanceData=Chemical.Substances.CarbonDioxide_gas(),
          PartialPressure=100000,
          TotalPressure=100000)
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      Modelica.Electrical.Analog.Basic.Ground ground
        ...
        Chemical.Obsolete.Sources.ExternalIdealGasSubstance O2_(
          ...
          TotalPressure=100000)
          annotation (Placement(transformation(extent={{0,36},{-20,56}})));
        Chemical.Obsolete.Components.Substance AcAc(
          redeclare package stateOfMatter = Chemical.Interfaces.Incompressible,
