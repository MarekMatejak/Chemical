...
package Topology
  ...
  model SplitterT1 "Splits a flow into two subflows"
    ...
    Chemical.Interfaces.Inlet inlet
      annotation (Placement(transformation(
          ...
          rotation=0,
          origin={-100,0})));
    Chemical.Interfaces.Outlet outletA
      annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=90,
          origin={0,100})));
  ...
  model JunctionT1 "2 to 1 T-Junction"
    ...
    Chemical.Interfaces.Outlet outlet
      annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-100,0})));
    Chemical.Interfaces.Inlet inletA
      annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=-90,
          origin={0,100})));
    Chemical.Interfaces.Inlet inletB
      annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=90,
          origin={0,-100})));
  ...
  model SplitterX "Splits a flow into three subflows"
    ...
    Chemical.Interfaces.Outlet outletC
      annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=0,
          origin={100,0})));
  ...
  model JunctionX3 "3 to 1 X-Junction"
    ...
    Chemical.Interfaces.Inlet inletB
      annotation (Placement(transformation(
          ...
          rotation=180,
          origin={100,0})));
    Chemical.Interfaces.Inlet inletC
      annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=90,
          origin={0,-100})));
